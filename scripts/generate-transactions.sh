...
mock_keypair_file="fixtures/mock-keypair.json"
mock_mint_keypair_file="fixtures/mock-mint-keypair.json"

solana-keygen new --no-bip39-passphrase -o $mock_keypair_file
solana transfer --allow-unfunded-recipient --url $rpc_endpoint $mock_keypair_file 1

solana-keygen new --no-bip39-passphrase -o $mock_mint_keypair_file
